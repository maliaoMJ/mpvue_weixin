...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  config: {
    ...
    pages: ['pages/logs/main', '^pages/index/main', 'pages/found/main', 'pages/sale/main', 'pages/user/main', 'pages/video/main', 'pages/user/main'],
    window: {
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-f3110b42", Component.options)
  } else {
    hotAPI.reload("data-v-f3110b42", Component.options)
  }
